...
//! See main.rs for details. This file contains the UEFI
//! implementation of the fake EDID protocol installation,
//! while main.rs provides the UEFI entrypoint and a stub
//! `main()` on non-UEFI targets so the crate can still be
//! built there.
